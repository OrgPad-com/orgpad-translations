...
(def dict
  ...
  (merge
    ...
    {:address/company                                 "Company name"
     ...
     :attachments/display-using-microsoft-365         "Display using Microsoft 365"
     :attachments/edit-filename                       "Edit name"
     :attachments/title-order                         "Alphabetically by title"
     :attachments/upload-order                        "Newest at the top"
     :attachments/size-order                          "Largest at the top"
     :attachments/split-used-unused                   "Group by presence in OrgPage"
     :attachments/search                              "Search"
     :attachments/ordering                            "Ordering"
     :attachments/new-version                         "New version"
     :attachments/preserve-old-version                "Preserve the old version"
     :attachments/in-other-orgpages                   "Replace in other OrgPages:"
     ...
     :checkout/professional-plan                      "Professional plan"
     :checkout/school-plan                            "School plan"
     :checkout/enterprise-plan                        "Enterprise plan"
     ...
     :dashboard/new-domain                            [:<> "Use the new domain " [:a {:href "https://orgpad.info/list"} "orgpad.info"]
                                                       ". More information in OrgPage " [:a {:href "https://orgpad.info/s/new-domain"} "Changes in OrgPad and new domain"] "."]
     ...
     :dashboard-filter/last-modified-order            "Last modified at the top"
     ...
     :export/show                                     "Export OrgPage"
     :export/title                                    "Export {orgpage/title}"
     :export/info                                     "Choose the format in which this OrgPage is exported."
     :export/edn                                      [:<> [:a.link-button {:href   "https://github.com/edn-format/edn"
                                                                            :target "_blank"} "EDN"]
                                                       " format used by OrgPad"]
     :export/html                                     "A linear HTML file"
     ...
     :feedback/dialog-title                           "Contact OrgPad Creators"
     :feedback/description                            [:<> "If you need help or have any problem, please let us - "
                                                       [:b "the creators of OrgPad"] " know. "
     ...
     :feedback/org-plan                               (fn [{:user/keys     [email]
                                                            :feedback/keys [phone]}]
                                                        [:<> "Use this form to contact an OrgPad s.r.o. representative."
                                                         " We will get back to you shortly at the phone number or email address you provided (" email
     ...
     :fragment/create                                 "Create location"
     :fragment/create-tooltip                         "TAB; hold SHIFT to copy the selected location"
     :fragment/remove                                 "Remove location"
     :fragment/share                                  "Copy a link to this location"
     :fragment/text-id-required                       "Id required."
     :fragment/text-id-already-used                   "Id already used."
     :fragment/closed-books                           "Closed cells; CTRL+click to select"
     :fragment/hidden-books                           "Hidden cells; CTRL+click to select"
     :fragment/opened-pages                           "Opened pages; CTRL+click to select"
     :fragment/focused-books                          "Cells shown in camera; CTRL+click to select"
     :fragment/shown-books                            "Revealed cells; CTRL+click to select"
     ...
     :info/audio-not-allowed                          "Playing audio blocked. Click the play button."
     :info/audio-not-supported                        "Audio format not supported."
     ...
     :loading/initial-autoresize                      (fn [{:loading/keys [num-units]}]
                                                        [:<> "Computing sizes of all cells, " [:span#autoresize-num-units num-units] " remaining …"])
     ...
     :loading/getting-blog                            "Downloading blog from the server …"
     ...
     :login/continue-with-cuni                        "Continue with Charles University"
     ...
     :login/forgotten-password-error                  [:<> "This email address is blocked by you. Either unblock it by clicking Unsubscribe in any email from OrgPad, or send us an email to "
                                                       company/support-email-app-link " from this email address."]
     ...
     :markdown/title                                  "Is pasted text formatted by Markdown?"
     :markdown/info                                   "Markdown formatting detected in your pasted content. Would you like to apply its formatting?"
     :markdown/remember                               "Remember till reload"
     :markdown/insert                                 "Use Markdown formatting"
     :markdown/ignore                                 "Keep original"

     :meta/title                                      "OrgPage's name"
     :meta/orgpage-thumbnail                          "OrgPage image"
     :meta/automatic-screenshot-start                 "Automatically generated screenshot for "
     :meta/automatic-screenshot-refresh               "Updates five minutes after each change."
     ...
     :meta/new-tags                                   "Tag"
     :meta/tag-too-long                               (str "Max length of a tag is " common-orgpage/max-tag-length " characters.")
     :meta/too-many-tags                              (str "At most " common-orgpage/max-tags " tags allowed.")
     :meta/info                                       (str "These details will be displayed in the OrgPage list, "
                                                           "when embedding an OrgPage, and when sharing it on social networks.")
     :meta/info-in-share-orgpage                      "Before you can share this OrgPage, the title needs to be set."
     ...
     :meta/info-title                                 "Information – {meta/title}"
     :meta/info-title-only                            "Name the OrgPage"
     :meta/details                                    "Details"
     :meta/preview                                    "Preview"
     :meta/init-fragments                             "Starting location"
     :meta/init-fragments-info                        (str "You can choose starting location when the OrgPage is opened. "
                                                           "A different starting location can be specified for mobile devices.")
     :meta/desktop-init-fragment                      "Desktop's location"
     :meta/mobile-init-fragment                       "Mobile's location"
     :meta/everything-closed                          "All cells closed"
     :meta/everything-closed-lowercase                "all cells closed"
     :meta/more-details                               "More information"
     :meta/move-to-new-orgpage-title                  "Move to {meta/title}"
     :meta/move-to-new-orgpage                        "Move to a new OrgPage"

     :microsoft-365-permission/title                  "Allow Microsoft 365 access to this document?"
     :microsoft-365-permission/info                   [:<> "The Office document can be displayed using Microsoft 365."
                                                       " By clicking on agree, your document will be shared with Microsoft."
                                                       " Check " [:a.link-button {:href   "https://www.microsoft.com/en/servicesagreement/"
                                                                                  :target "_blank"}
                                                                  "Microsoft Service Agreement"] "."]
     :microsoft-365-permission/allow                  "Grant permission to Microsoft 365"
     ...
     :orgpage-print/displayed                         "Exactly as displayed"
     :orgpage-print/displayed-info                    "Everything inside the rectangle will be printed exactly as you see it."
     :orgpage-print/done                              (fn [{:orgpage-print/keys [link]}]
                                                        [:<> "OrgPage successfully printed into "
                                                         [:a.link-button {:href   link
                                                                          :target "_blank"} "PDF"] "."])
     :orgpage-print/estimated-time                    "Printing this PDF should take about {orgpage-print/estimated-time}."
     :orgpage-print/everything-closed                 "All cells closed"
     :orgpage-print/everything-closed-info            "The printed PDF displays all cells closed."
     :orgpage-print/fragment                          "A location"
     :orgpage-print/fragment-info                     "The printed PDF displays the selected location."
     :orgpage-print/gray                              "Gray background"
     :orgpage-print/landscape                         "Landscape"
     :orgpage-print/orientation                       "Orientation"
     :orgpage-print/path-info                         [:i18n/plural " with {orgpage-print/num-pages} {orgpage-print/page-label}."
                                                       #:orgpage-print{:page-label [:orgpage-print/num-pages
                                                                                    "pages" "page" "pages"]}]
     :orgpage-print/portrait                          "Portrait"
     :orgpage-print/presentation                      "Steps of a presentation"
     :orgpage-print/presentation-info                 "Each step is printed on a separate page."
     :orgpage-print/print                             "Print to PDF"
     :orgpage-print/size                              "Size"
     :orgpage-print/started                           (str "We are printing this OrgPage into PDF. It should take about {orgpage-print/estimated-time}."
                                                           " When done, it will be available as a file.")
     :orgpage-print/title                             "Print name"
     :orgpage-print/type                              "What is printed"
     :orgpage-print/watermark                         "Include watermark"
     :orgpage-print/watermark-info                    "Upgrade to professional, school or enterprise to remove."
     :orgpage-print/white                             "White background"
     ...
     :panel/toggle-side-panel                         "Side menu"
     ...
     :panel/search                                    "Search (CTRL+F)"
     :panel/toggle-reveal-hidden                      [:i18n/plural "Reveal {panel/num-hidden-book-ids} {panel/unit-label} hidden in the current location"
     ...
     :password-reset/enter-new-password               "Enter the new password."

     :path/add-step                                   "Step"
     :path/add-step-tooltip                           "ENTER or TAB; hold SHIFT to copy the camera"
     :path/hidden-ops                                 " and {path/num-hidden} more"
     :path/title                                      "Presentation's name"
     :path/default-title                              "Presentation {path/num-paths}"
     :path/copy                                       "Copy into a new presentation"
     :path/copy-suffix                                "copy"
     :path/add-audio                                  "Link audio to step"
     :path/remove-audio                               "Unlink audio from step"

     :paths/create-new-path                           "Create a presentation"
     :paths/confirm-path-deletion                     (fn [{:path/keys [title]}]
                                                        [:<> "Delete the presentation " [:b title] "?"])
     :paths/help                                      "Select cells to change what’s shown; see guide for details."
     ...
     :payments/expired-subscription                   (fn [{:subscription/keys [tier end-date]}]
                                                        [:<> "Your " [:b tier " plan"] " expired at " [:b end-date] " since your renewal payment failed."
                                                         " If you fix your payment, your subscription will be automatically extended."])
     ...
     :payments/billing-address-info                   (str "The entered billing address will be used on all new invoices."
                                                           " Recent invoices are also automatically updated.")
     ...
     :presentation/respect-audio-track                "Step duration according to the audio track"
     :presentation/stop-slideshow                     "Stop automatically playing steps"
     :presentation/exit-tooltip                       "Exit presentation"
     :presentation/play-audio                         "Play audio for this step"
     :presentation/pause-audio                        "Pause playing audio"
     ...
     :pricing-popup/print-watermark-title             "Upgrade your plan for no watermarks"
     :pricing-popup/print-watermark-info              (str "Printing without OrgPad.info watermarks is only possible"
                                                           " in professional, school and enterprise plans.")
     ...
     :profile/contact-dialog-title                    (fn [{:profile/keys [first-name last-name]}]
                                                        (if (or (not (str/blank? first-name))
                                                          ...
                                                          "Contact this person"))
     :profile/contact-dialog-info                     (str "Since we do not share the email addresses of other people in OrgPad, we will send this message for you. "
                                                           "We will include your name and email to provide a direct contact.")
     ...
     :selection/force-closing                         "Hide these contents when opening the location (ESC)"
     :selection/step-focus-camera                     "Focus this step's camera on exactly the selected cells (F2 or Q); hold SHIFT to add them, hold ALT to remove them."
     :selection/fragment-focus-camera                 "Focus location's camera on exactly the selected cells (F2 or Q); hold SHIFT to add them, hold ALT to remove them."
     :selection/step-show-books                       "Show exactly the selected cells in this step (F3 or W); hold SHIFT to add them, hold ALT to remove them."
     :selection/fragment-show-books                   "Show exactly the selected cells in the location (F3 or W); hold SHIFT to add them, hold ALT to remove them."
     :selection/force-showing                         "Reveal the selected cells when previously hidden"
     :selection/share-units                           "Copy a link displaying the selected units; hold SHIFT to open location's settings instead"
     :selection/move-to-new-orgpage                   "Move to a new OrgPage"
     :selection/change-code-lang                      "Change code language"
     ...
     :settings/account-linked-to-cuni                 [:<> " Your account is " [:b " linked "] " to Charles University."]
     :settings/account-not-linked-to-cuni             [:<> " Your account is " [:b " not linked "] " to Charles University."]
     :settings/link-cuni                              "Link Charles University"
     :settings/unlink-cuni                            "Unlink Charles University"
     :settings/set-password-text                      " Set password before unlinking."
     :settings/linked-accounts-info                   "Link your Facebook, Google, Microsoft or Charles University account to OrgPad so you can use them to log in."
     ...
     :share-orgpage/everything-closed                 "Display all cells closed"
     :share-orgpage/presentation                      "Start with a presentation"
     :share-orgpage/fragment                          "Display a location"
     ...
     :side-panel/terms-and-conditions                 "Terms and Conditions"
     :side-panel/privacy-and-security                 "Privacy and Security"
     :side-panel/files-and-images                     "Files and images"
     :side-panel/paths                                "Presentations"
     :side-panel/fragments                            "Locations"
     ...
     :step/closed-books                               "Closed cells; CTRL+click to select"
     :step/everything-closed                          "Everything closed"
     :step/hidden-books                               "Hidden cells; CTRL+click to select"
     :step/nothing-changed                            "Nothing changed"
     :step/opened-pages                               "Opened pages; CTRL+click to select"
     :step/focused-books                              "Cells shown in camera; CTRL+click to select"
     :step/shown-books                                "Revealed cells; CTRL+click to select"
     :step/switched-pages                             "Switched pages; CTRL+click to select"
     ...
     :style-select/set-comment-safari                 "Change into a comment cell with your profile image (SHIFT+CMD+,)"
     :style-select/unset-comment-safari               "Change into a normal cell, removing the profile image (SHIFT+CMD+,)"
     ...
     :unit-editor/add-page                            "Create another page (CTRL+PAGEDOWN)"
     :unit-editor/delete-page                         "Remove this page"
     :unit-editor/previous-page                       (str "Previous page (PAGEUP);"
                                                           " hold SHIFT to move this page to the left (SHIFT+PAGEUP);"
                                                           " hold CTRL to add another page before this page (CTRL+PAGEUP)")
     :unit-editor/next-page                           (str "Next page (PAGEDOWN);"
                                                           " hold SHIFT to move this page to the right (SHIFT+PAGEDOWN);"
                                                           " hold CTRL to add another page after this page (CTRL+PAGEDOWN)")
     ...
     :unit-editor/toggle-list-ul                      "Bulleted list (TAB)"
     ...
     :unit-editor/center                              "Center align (CTRL+L)"
     :unit-editor/heading                             "Heading (CTRL+G)"
     :unit-editor/embed-pdf                           "Show PDF content"
     :unit-editor/link-pdf                            "Replace PDF content with its hyperlink"
     :unit-editor/embed-office                        "Show document content using Microsoft 365"
     :unit-editor/link-office                         "Replace document content with its hyperlink"
     ...
     :unit-editor/open-image-in-attachments           "Open this image in the list of attachments"
     :unit-editor/open-file-in-attachments            "Open this file in the list of attachments"
     ...
     :unit-editor/website-id-info                     (fn [{:embed-messaging/keys [info]}]
                                                        [:<> "Used for "
                                                         [:a.link-button {:href   info
                                                                          :target "_blank"} "sending messages between websites"] "."])
     :unit-editor/invalid-website-url                 "Invalid website address or code"
     :unit-editor/invalid-video-url                   "Invalid video address"
     ...
     :unit-editor/copy-code                           "Copy code"
     :unit-editor/insert-math-shortcut                "CTRL+U, CTRL+M"
     :unit-editor/toggle-block-code                   "Code as a separate paragraph"
     :unit-editor/toggle-block-math                   "Math on a separate line"
     :unit-editor/remove-code                         "Remove code formatting"
     :unit-editor/insert-math                         "Math / Chemistry"
     ...
     :usergroup/create                                "Create a team"
     :usergroup/edit-title                            "Edit {usergroup/name}"
     :usergroup/info                                  "Create and manage teams of your friends and coworkers to simplify sharing OrgPages."
     :usergroup/delete                                "Delete team"
     :usergroup/members                               "Members"
     :usergroup/edit                                  "Change team name and logo"
     :usergroup/show-actions                          "Show actions"
     :usergroup/name                                  "Name"
     :usergroup/hide-orgpages                         "Hide shared OrgPages"
     :usergroup/hide-orgpages-tooltip                 "They can be displayed by turning the team on in filter"
     :usergroup/hide-in-filter                        "Hide in the filter"
     :usergroup/create-info                           "The team name and profile picture are visible only to team members."
     :usergroup/confirm-delete                        [:<> [:b "Permanently"] " delete this team?"]
     :usergroup/members-title                         "{usergroup/name}'s members"
     :usergroup/remove-member                         "Remove from team"
     :usergroup/remove-admin                          "Remove admin"
     :usergroup/make-admin                            "Make admin"
     :usergroup/admin-tooltip                         "An admin can manage the members and delete the team."
     :usergroup/copy-usergroup                        "Copy team"
